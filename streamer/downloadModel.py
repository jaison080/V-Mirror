...
def download_oss_model(model_path: str):
  ...
  if os.path.exists(model_abspath):
    print('Model already exists at ' + model_abspath)
    return
...
if __name__ == '__main__':
    download_oss_model('/usr/local/lib/python3.10/dist-packages/mediapipe/modules/pose_landmark/pose_landmark_lite.tflite')